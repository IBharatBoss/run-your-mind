function d(){let e="./",s=window.location.pathname.endsWith("/")||window.location.pathname.endsWith("index.html"),a=["/mindset/","/productivity/","/survival/","/wealthandskills/","/policy/"].some(t=>window.location.pathname.includes(t));!s&&a&&(e="../");let o=`
        <header class="top-header ${e==="../"?"editorial-header-flow":""}">
            ...
            <div id="logo-container" class="logo-container">
                <img src="${e}logo.webp" alt="Run Your Mind" class="top-logo" id="top-logo" width="220" height="55" ${e==="../"?'style="width: 130px; min-width: 120px; margin: 0;"':""}>
    ...
    `,n=document.querySelector("header.top-header"),r=document.querySelector("footer.app-footer");if(n)n.outerHTML=o;else{let t=document.querySelector(".page-shell");t&&t.insertAdjacentHTML("afterbegin",o)}if(r)r.outerHTML=i;else{let t=document.querySelector(".page-shell");t&&t.insertAdjacentHTML("beforeend",i)}}export{d as initLayout};
