function d(){let e="./";const s=window.location.pathname.endsWith("/")||window.location.pathname.endsWith("index.html"),a=["/mindset/","/productivity/","/survival/","/wealthandskills/","/policy/"].some(t=>window.location.pathname.includes(t));!s&&a&&(e="../");const o=`
        <header class="top-header ${e==="../"?"editorial-header-flow":""}">
            ${e==="../"?`
            <div class="header-left">
                <a href="${e}index.html" class="back-to-library">
            ...
            <div id="logo-container" class="logo-container">
                <img src="${e}logo.png" onerror="this.onerror=null;this.src='${e}run-your-mind.png';" alt="Run Your Mind" class="top-logo" id="top-logo" width="220" height="55" ${e==="../"?'style="width: 130px; min-width: 120px; margin: 0;"':""}>
    ...
    `,i=`
        <footer class="app-footer">
            ...
            <div style="margin-top: 2.5rem; display: flex; flex-wrap: wrap; justify-content: center; gap: 1.5rem; font-family: var(--font-sans); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em;">
                <a href="${e}policy/terms.html" target="ReaderTab" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Terms & Conditions</a>
                <a href="${e}policy/privacy.html" target="ReaderTab" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Privacy Policy</a>
                <a href="${e}policy/refund.html" target="ReaderTab" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Refund Policy</a>
                <a href="${e}policy/contact.html" target="ReaderTab" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Contact Us</a>
            </div>

            <div class="footer-credits">
                <p>\xA9 ${new Date().getFullYear()} RUN YOUR MIND \xB7 All rights reserved</p>
            </div>
        </footer>
    `,n=document.querySelector("header.top-header"),r=document.querySelector("footer.app-footer");if(n)n.outerHTML=o;else{const t=document.querySelector(".page-shell");t&&t.insertAdjacentHTML("afterbegin",o)}if(r)r.outerHTML=i;else{const t=document.querySelector(".page-shell");t&&t.insertAdjacentHTML("beforeend",i)}}export{d as initLayout};
