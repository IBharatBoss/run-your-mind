    ...
    const headerHTML = `
        <header class="top-header ${rootPath === '../' ? 'editorial-header-flow' : ''}">
            ...
            <div id="logo-container" class="logo-container">
                ...
                <img id="founder-img" src="${rootPath}me.jpg" alt="Founder" width="380" height="380" loading="lazy" ${rootPath === '../' ? 'onerror="this.src=\'https://via.placeholder.com/60\';"' : ''}>
                <span id="founder-text">FOUNDER</span>
            </div>
    ...
    const footerHTML = `
        <footer class="app-footer">
            ...
            <div style="margin-top: 2.5rem; display: flex; flex-wrap: wrap; justify-content: center; gap: 1.5rem; font-family: var(--font-sans); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em;">
                <a href="${rootPath}policy/terms.html" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Terms & Conditions</a>
                <a href="${rootPath}policy/privacy.html" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Privacy Policy</a>
                <a href="${rootPath}policy/refund.html" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Refund Policy</a>
                <a href="${rootPath}policy/contact.html" style="color: var(--ink-muted); text-decoration: none; transition: color 0.2s ease;" onmouseover="this.style.color='var(--ink)'" onmouseout="this.style.color='var(--ink-muted)'">Contact Us</a>
            </div>
